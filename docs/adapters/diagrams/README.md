...
|-----------|-------|------------|------------------|
| **US Deadbolt** | ![Nuki US](nuki-us-smart-lock.png) | USA, Canada | ✅ Smart Lock (US) |
| **Euro Cylinder** | ![Cylinder Types](cylinder-types.webp) | Europe, SEA | ✅ Smart Lock Pro |
| **Lockwood 001 Rim Lock** | ![Lockwood](lockwood-001-rimlock.jpg) | Australia | ❌ NOT COMPATIBLE |

### The Australian Problem: Lockwood 001

![Lockwood 001 Rim Lock](lockwood-001-rimlock.jpg)
...
![Nuki Installation Exploded](nuki-installation-exploded.webp)
...
![Nuki Pro Explosion](nuki-pro-explosion.webp)
...
| Before | After |
|--------|-------|
| ![Before - Yale lock](installation-before-yale.jpg) | ![After - Nuki mounted](installation-after-mounted.jpg) |
| Existing euro cylinder with key | Nuki Smart Lock mounted over cylinder |

### Cylinder Assembly

![Cylinder Assembly](cylinder-assembly.jpg)

Shows how the cylinder and Nuki connect.

### What's in the Box

![Unboxed Components](unboxed-components.jpg)
...
![Compatibility Requirements](compatibility-requirements.webp)

The key measurements to verify before buying.

### Cylinder Types

![Cylinder Types](cylinder-types.webp)
...
|----------------|-----------------|
| ![Inwards](dimensions-inwards.webp) | ![Outwards](dimensions-outwards.webp) |
| Min clearances for doors opening inward | Min clearances for doors opening outward |

### Key Orientation

![Key Orientation](key-orientation.webp)
...
![All Knob Adapters](knob-adapters-all.webp)
...
![Smart Lock Pro on Door](smart-lock-on-door.webp)
...
- [Adapters Guide](../README.md) - Main adapters documentation
- [Adapter Images](../images/) - Color-coded adapter photos
- [3D Models](../3d/) - Printable adapters
- [Asia/Australia Gaps](../ASIA-AUSTRALIA-GAPS.md) - Market analysis
