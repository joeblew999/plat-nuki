...
See [3d/README.md](3d/README.md) for printable adapters:
...
See [3d/README.md](3d/README.md) for design guidelines.
...
- [Adapter Types](types/README.md) - Detailed guide for each adapter type (8 EU colors + US + Nordic + Custom)
- [Country Guides](countries/README.md) - Per-country compatibility, adapters, and buying guides (20+ countries)
- [Door Lock Types](../door-lock-types.md) - Understanding different lock standards
- [Visual Diagrams](diagrams/README.md) - Photos showing what all this jargon actually means
- [3D Models](3d/README.md) - Printable adapters and accessories
- [Asia/Australia Gaps](ASIA-AUSTRALIA-GAPS.md) - Market analysis and solutions for APAC deployment
